...
- I use the anime.js [documentation](https://animejs.com/documentation/) to learn the syntax, and I looked at some of the [examples](https://codepen.io/collection/XLebem/) they listed.
- After I figure out how to use it, I played with different animations, and I created simple animation of a [ball](https://codedeoj.github.io/plugin-away/) bouncing up and down.
